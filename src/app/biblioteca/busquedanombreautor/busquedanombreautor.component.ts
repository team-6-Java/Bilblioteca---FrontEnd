...
@Component({
  selector: 'app-busqueda-busquedanombreautor',
  templateUrl: './busquedanombreautor.component.html',
  styleUrls: ['./busquedanombreautor.component.css']
})
export class BusquedaBusquedanombreautorComponent implements OnInit {
